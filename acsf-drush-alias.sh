...
acsf_app_name="your_acsf_app_name"
...
create_new_site_alias () {
   echo "Make sure to enter the name of a site that already exists in your ACSF account."
   echo "Example: If your site's ACSF URL is:"
   echo "site1.${acsf_app_name}.acsitefactory.com"
   echo "Enter site1"
   echo " "
   confirmation="novalue"
   while [ $confirmation != "y" ]
   do
       echo -e "Enter the name of the site for which you want to create a Drush alias: \c "
       read site_name
       echo " "
...
echo "          <--------------->"
echo " <--------------------------------->"
echo " |    ACSF Drush Alias Generator    |"
echo " <--------------------------------->"
echo "          <--------------->"
echo "              <------->"
# Main Menu
